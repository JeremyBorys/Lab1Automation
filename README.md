...
## Installation:
Download and extract all the files to the local matlab path "C:\Documents and Settings\%USERNAME%\My Documents\Matlab\" or "%USERPROFILE%\My Documents\Matlab\"

NOTE: %USERNAME% refers to the current username of the user account
      %USERPROFILE% is the user directory
